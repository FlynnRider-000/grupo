    ...
    if ($do["type"] === "pm") {
        if (isset($GLOBALS["roles"]['privatemsg'][2])) {
            if (isset($GLOBALS["roles"]['users'][4])) {
                ...
                $list[0]->mnu = 'mmenu';
                $list[0]->act = 'users';
            } else if ($GLOBALS["default"]->show_online_tab != 'enable' && isset($GLOBALS["roles"]['users'][5])) {
                $list[0]->shw = 'shw';
                $list[0]->icn = 'gi-users';
                $list[0]->mnu = 'mmenu';
                $list[0]->act = 'online';
        ...
        if (isset($do['filtr']) && !empty($do['filtr']) || !$GLOBALS["logged"]) {
            $GLOBALS["default"]->temporary = $GLOBALS["default"]->pingroup;
        ...
        if (isset($do['filtr']) && $do['filtr'] == 'unjoined') {
            ...
            $GLOBALS["default"]->pingroup = $GLOBALS["default"]->temporary;
            $query = 'SELECT gr.*,';
